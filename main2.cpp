...
extern "C" {
	...
	int fattoria(bool* TP, bool* TM, bool* TG, bool* MT, bool* FO, bool* BA, bool* CA, bool* CO, bool* UV, bool* OL, bool* F, bool* D, bool* S1, bool* N1, bool* S2, bool* N2, const movement& up) {
		...
		sf::Texture texture;
		if (!texture.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/map1.jpg")) {
		...
		sf::Texture texta;
		if (!texta.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/avatar2d.png")) {
			std::cerr << "Failed to create texture from file!" << std::endl;
			return -1;
		}
		...
		sf::Texture textt;
		if (!textt.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/dirt.png")) {
			std::cerr << "Failed to create texture from file!" << std::endl;
			return -1;
		}
		...
		sf::Texture textb;
		if (!textb.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/ortaggi.png")) {
			std::cerr << "Failed to create texture from file!" << std::endl;
			return -1;
		}
		...
		//Caricamento immagine barbabietole
		sf::Texture textb2;
		if (!textb2.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/ortaggi.png")) {
			std::cerr << "Failed to create texture from file!" << std::endl;
			return -1;
		}
		...
		sf::Texture textt2;
		if (!textt2.loadFromFile("C:/Users/matti/Desktop/Gioco C/Game/x64/Debug/dirt2.png")) {
			std::cerr << "Failed to create texture from file!" << std::endl;
			return -1;
		}
		...
		sf::Font font;
		if (!font.loadFromFile("C:/Users/matti/Desktop/Gioco C/Font/G_ari_bd.ttf")) {
